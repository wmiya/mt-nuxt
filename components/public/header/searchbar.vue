<template>
  <div class="search-panel">
    <el-row class="m-header-searchbar">
      <el-col :span="3"
              class="left">
        <nuxt-link to="/"> <img src="//s0.meituan.net/bs/fe-web-meituan/e5eeaef/img/logo.png"
               alt="美团"></nuxt-link>
      </el-col>
      <el-col :span="15"
              class="center">
        <div class="wrapper">
          ...
          <button class="el-button el-button--primary"
                  @click="getproducts"><i class="el-icon-search" /></button>
          <dl v-if="isHotPlace"
              class="hotPlace">
            <dt>热门搜索</dt>
...
export default {
  ...
  methods: {
    getproducts: function () {
      window.location.href = `/products?keyword=${this.search}`
    },
    focus: function () {
      this.isFocus = true
    },
